...
del zoneCursor
#arcpy.TruncateTable_management(PR_FLAG_SUMMARY) #TODO Temp for testing
#arcpy.Append_management(PR_FLAG_Temp, PR_FLAG_SUMMARY, 'NO_TEST') #TODO Temp for testing
#arcpy.Delete_management(PR_FLAG_Temp) #TODO Temp for testing
