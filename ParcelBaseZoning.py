...
try:
    ...
    Zoning_BaseDistricts = 'Database Connections\\GEODB2.sde\\GIS_PLANNING.Zoning_BaseDistricts'
    Zoning_Overlays= 'Database Connections\\GEODB2.sde\\GIS_PLANNING.Zoning_Overlays'

    PWD_PARCELS_GEODB2 = 'Database Connections\\GEODB2.sde\\GIS_WATER.PWD_PARCELS'

    Council_Districts_2016 = 'Database Connections\\GEODB2.sde\\GIS_PLANNING.Council_Districts_2016'
    ...
    if locallySaved is not None:
        ...
        locallySaved = []
    localFiles = [[zoningFC, Zoning_BaseDistricts], [PWD_Parcels_Local, PWD_PARCELS_GEODB2], [Council_Districts_Local, Council_Districts_2016]]
    ...
    zoneCursor = arcpy.da.UpdateCursor(PR_FLAG_Temp, ['PWD_PARCEL_ID', 'BASE_ZONING'])
